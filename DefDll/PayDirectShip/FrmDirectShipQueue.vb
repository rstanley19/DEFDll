...
Public Class FrmDirectShipQueue
    ...
    Dim WithEvents myFrmDirectShipDocumentType As FrmDirectShipDocumentType
    Friend WithEvents CmdPrint As System.Windows.Forms.Button
    Friend WithEvents CmdCopyToClipboard As System.Windows.Forms.Button
    Dim WithEvents myFrmInvDirectShip As FrmInvDirectShip2023
...
#End Region
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmDirectShipQueue))
        ...
        Me.PictureBox1.FrameShadowSize = New System.Drawing.SizeF(0.0!, 0.0!)
        Me.PictureBox1.FramesIsPartOfImage = True
        Me.PictureBox1.FrameSize = New System.Drawing.SizeF(0.0!, 0.0!)
        ...
        Me.GrpDispatch.Controls.Add(Me.CmdPrint)
        Me.GrpDispatch.Controls.Add(Me.CmdCopyToClipboard)
        ...
        Me.CmdPrint.Location = New System.Drawing.Point(582, 12)
        Me.CmdPrint.Name = "CmdPrint"
        Me.CmdPrint.Size = New System.Drawing.Size(66, 20)
        ...
        Me.CmdCopyToClipboard.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.CmdCopyToClipboard.ForeColor = System.Drawing.SystemColors.ControlText
        Me.CmdCopyToClipboard.Location = New System.Drawing.Point(654, 12)
        Me.CmdCopyToClipboard.Name = "CmdCopyToClipboard"
        Me.CmdCopyToClipboard.Size = New System.Drawing.Size(122, 20)
        Me.CmdCopyToClipboard.TabIndex = 2
        Me.CmdCopyToClipboard.Text = "Copy to Clipboard"
        Me.CmdCopyToClipboard.UseVisualStyleBackColor = False
        '
        'TabControl1
        '
        ...
        Me.Name = "FrmDirectShipQueue"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Direct Ship Queue"
...
#Region "Build Direct Ship Queue"
    ...
    Private Sub myFrmDirectShipDocumentType_ShowInvFreight(PassImgLo As Integer, PassDocNbr As Integer, PassDocType As Integer, PassDeleteThisPage As Boolean) Handles myFrmDirectShipDocumentType.ShowInvFreight
        If Not PassDocNbr = 0 Then
            myFrmInvDirectShip = New FrmInvDirectShip2023
            myFrmInvDirectShip.ShowMe(Convert.ToInt32(UltraGridInvoices.ActiveRow.Cells("Invoice").Value), PassImgLo, PassDocNbr, PassDocType, UltraGridInvoices.ActiveRow.Cells("Vendor #").Value, UltraGridInvoices.ActiveRow.Cells("Vendor").Value, "", 0, UltraGridInvoices.ActiveRow)
        End If
    ...
    Private Sub myFrmInvDirectShip_PayInvoice(BackRow As Infragistics.Win.UltraWinGrid.UltraGridRow) Handles myFrmInvDirectShip.PayInvoice
        BackRow.Delete()
    End Sub
    ...
    Private Sub RefreshMe()
        ...
        Daily_QryData = connAS400.Execute("SELECT odvnds ,VNDMNM, ODINV#, SODDAT, CMNAME, ifnull(CMCITY, 'Unknown') as cmcity, ifnull(CMST, '??') as cmst, soacc#, sostat, ifnull(docs, 0) as docs " &
        "FROM daily.soorddp left join daily.soinvp on odinv# = soinv# left join daily.mscustp " &
        "on cmacc# = soacc# left join parafiles.appvnd on odvnds = vndnum " &
        "left join (select count(*) as docs, bxinv# from daily.soblfxp where bxtype in (201, 202, 203) " &
        "group by bxinv#) as d on bxinv# = odinv# " &
        "WHERE soinv# " &
        "is not null and not sodel in ('D', 'F') and not oddish = '' and not odpdco = 'Y' and odfrto = '' GROUP BY odvnds,  " &
        "vndmnm, odinv#, soddat, cmname, cmcity, cmst, soacc#, sostat, docs", Parms, -1)
    ...
    Private Sub UpdateDataSet(ByVal invoice As Integer, ByVal Carrier1 As Integer, ByVal Carrier2 As Integer)
        ...
        If Not (foundRows Is Nothing) Then
            ...
            For Each r In foundRows
                Dim myMsCarrp As New SharedDll.Iseries.msCarrp(Carrier1)
                r("Car 1") = myMsCarrp.caName
                r("carrier #") = Carrier1
...
#Region "Build Invoices"
    Public Sub LoadDataSetInvoices(ByRef rs As ADODB.Recordset, ByVal UpdateOneInvoice As Boolean)
        ...
        While Not rs.EOF
            ...
            InvoiceRow("Vendor #") = rs.Fields("odvnds").Value
            If Not IsDBNull(rs.Fields("vndmnm").Value) Then
                InvoiceRow("Vendor") = rs.Fields("vndmnm").Value
            Else
                InvoiceRow("Vendor") = "Invalid"
            End If
    ...
    Public Sub BuildEmptyDataSetInvoices()
        ...
        InvoiceTable.Columns.Add("Vendor", GetType(String))
...
#Region "Show Page"
    ...
    Private Sub PictureBox1_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles PictureBox1.MouseDown
        ...
        Else
            If PictureBox1.ScaleFactor > 0.1 Then PictureBox1.ScaleFactor -= 0.1
        End If
        saveZoom = PictureBox1.ScaleFactor
    End Sub
...
#Region "Build Scan Queue"
    ...
    Public Sub LoadDataSetScan()
        ...
        Dim myDir As String = "\\ppc-data\share1\images\box\DirectShip\"
    ...
    Private Sub UltraGridScan_ClickCellButton(ByVal sender As System.Object, ByVal e As Infragistics.Win.UltraWinGrid.CellEventArgs) Handles UltraGridScan.ClickCellButton
        ...
        Select Case e.Cell.Column.Key
            ...
            Case Is = "Delete"
                ...
                File.Delete("\\ppc-data\share1\images\box\DirectShip\" & e.Cell.Row.Cells("Document").Value)
                e.Cell.Row.Delete()
    ...
    Private Sub GetImageScan(ByVal inFile As String)
        ...
        Try
            ...
            srcFileName = "\\ppc-data\share1\images\box\DirectShip\" & inFile
...
#Region "Document Section"
    ...
    Private Sub myFrmDirectShipDocumentType_CopyThisPage(PassDocumentNbr As Integer, PassImageLocation As Integer) Handles myFrmDirectShipDocumentType.CopyThisPage
        Try
            ...
            End If
            'codecs.Save(PictureBox1.Image, Folder & Format(PassDocumentNbr, "000000000") & ".tif", CurrentPageImageFormat, CurrentPagePixelFormat, 1, 1, 0, CodecsSavePageMode.Append)
            ...
            'codecs.Save(PictureBox1.Image, "C:\tiflzw.tif", RasterImageFormat.TifLzw, CurrentPagePixelFormat, 1, 1, 0, CodecsSavePageMode.Append)
        Catch
...
#End Region
    ...
    Private Sub FrmBillingQueue_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        'BillingQueueOpen = False
    End Sub
    ...
    Private Sub UltraGridInvoices_ClickCellButton(ByVal sender As System.Object, ByVal e As Infragistics.Win.UltraWinGrid.CellEventArgs) Handles UltraGridInvoices.ClickCellButton
        Select Case e.Cell.Column.Key
            ...
            Case Is = "Doc"
                ...
                myFrmDirectShipDocumentType = New FrmDirectShipDocumentType
                Me.Cursor = System.Windows.Forms.Cursors.WaitCursor
                myFrmDirectShipDocumentType.ShowMe(Convert.ToInt32(UltraGridInvoices.ActiveRow.Cells("Invoice").Value), Convert.ToInt32(UltraGridInvoices.ActiveRow.Cells("Account").Value), UltraGridInvoices.ActiveRow.Cells("Customer").Value)
                Me.Cursor = System.Windows.Forms.Cursors.Default
            Case Is = "Date"
                ...
                'pay
                myFrmInvDirectShip = New FrmInvDirectShip2023
                myFrmInvDirectShip.ShowMe(Convert.ToInt32(UltraGridInvoices.ActiveRow.Cells("Invoice").Value), 0, 0, 0, UltraGridInvoices.ActiveRow.Cells("Vendor #").Value, UltraGridInvoices.ActiveRow.Cells("Vendor").Value, "", 0, UltraGridInvoices.ActiveRow)
                'End If
