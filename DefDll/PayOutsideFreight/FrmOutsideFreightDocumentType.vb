Public Class FrmOutsideFreightDocumentType
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        '
        Me.RadioButtonVendorsInvoice.Checked = True
        ...
        Me.RadioButtonVendorsInvoice.TabStop = True
        Me.RadioButtonVendorsInvoice.Text = "Outside Freight Invoice"
        '
        'CmdKeep
        '
        ...
        Me.ToolTip1.SetToolTip(Me.CmdKeep, "Click here to keep this page on the Billing Work Queue.  You can then assign this" &
        ...
        Me.ToolTip1.SetToolTip(Me.RadioButtonVerifyLater, "Select this option to continue assigning documents to invoices and then verify at" &
        " a later time")
        '
        ...
        Me.Name = "FrmOutsideFreightDocumentType"
...
#End Region
    ...
    Private Function GetDocType() As Int32
        If RadioButtonVendorsInvoice.Checked Then Return 26
    ...
    Private Sub UpdateFile()
        ...
        With CallGeneric
            ...
            .CommandText = "insert into daily.soblfxp " &
            "( bxinv#," &
            " bxacc#," &
            " bxkey," &
            " bxtype," &
