    ...
    Public Class soApDip
        ...
        Sub Retrieve(ByVal GetID As Long)
            ...
            Else
                ...
                _diSupf = Convert.ToDecimal(Daily_GenericDATA.Fields("diSupf").Value)
                _found = True
            End If
        ...
        Sub Update()
            ...
            With Daily_GenericUpd
                ...
                .CommandText = "update daily.soApDip set " &
        "( diVen#, diRef#, dhtot$, diInv#, " &
        "diLin#, diQtpd, diCost, " &
        "diSub$, diSupf)" &
        " = " &
        "(" & _diVen_ & ", " &
        ...
        Sub Create()
            ...
            Daily_GenericUpd.Prepared = False
            With Daily_GenericUpd
                .CommandText = "insert into daily.soApDip " &
                "( diVen#, diRef#, diInv#, " &
                "diLin#, diQtpd, diCost, " &
                "diSub$, diSupf)" &
                " Values " &
